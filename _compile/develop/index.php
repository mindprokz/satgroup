    ...
    <sections class="restourant dark"><a name="Sunduk"></a>
      ...
      <div class="info">
        <div class="wrap"><img src="<?php echo get_template_directory_uri();?>/images/sunduk_site.png">
          <p>Tағамдар: шығыс, өзбек<br>Жұмыс уақыты: күнделікті 12:00-01:00<br>Мекен жайы: Астана қ., Керей, Жанибек хандар к-сі, 14/2<br>Тел.: +7 (7172) 222 888 +7701 070707 2</p><a href="#" class="button">Толығырақ</a>
        </div>
      </div>
    </sections>
    <sections class="restourant light"><a name="Butchers"></a>
      ...
      <div class="info">
        <div class="wrap"><img src="<?php echo get_template_directory_uri();?>/images/butchers_site.png">
          <p>Tағамдар: еуропа, аралас<br>Жұмыс уақыты: күнделікті 12:00-01:00<br>Мекен жайы: Астана қ., Керей, Жанибек хандар к-сі, 14/2<br>Тел.: +7 (7172) 222 555, +7701 070707 4</p><a href="#" class="button">Толығырақ</a>
        </div>
      </div>
    </sections>
    <sections class="restourant middle"><a name="Buno"></a>
      ...
      <div class="info">
        <div class="wrap"><img src="<?php echo get_template_directory_uri();?>/images/buno_site.png">
          <p>Tағамдар: еуропа, аралас<br>Жұмыс уақыты: күнделікті 12:00-01:00<br>Мекен жайы: Астана қ., Керей, Жанибек хандар к-сі, 14/2<br>Тел.: +7 (7172) 222 444, +7701 070707 3</p><a href="#" class="button">Толығырақ</a>
        </div>
      </div>
    </sections>
